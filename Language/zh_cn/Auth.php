...
* Created:  03.09.2013
*
* Description:  Simplified Chinese language file for Atomic Auth example views
*
*/
...
return [
	...
	'edit_user_validation_roles_label'           => '用户组',
	'edit_user_validation_password_label'         => '密码',
	'edit_user_validation_password_confirm_label' => '密码确认',

	// Create Group
	'create_role_title'                  => '创建用户组',
	'create_role_heading'                => '创建用户组',
	'create_role_subheading'             => '请输入下列用户名信息.',
	'create_role_name_label'             => '用户组名:',
	'create_role_desc_label'             => '用户组描述:',
	'create_role_submit_btn'             => '创建用户组',
	'create_role_validation_name_label'  => '用户组名',
	'create_role_validation_desc_label'  => '用户组描述',

	// Edit Group
	'edit_role_title'                  => '修改用户组',
	'edit_role_saved'                  => '用户组已保存',
	'edit_role_heading'                => '修改用户组',
	'edit_role_subheading'             => '请输入下列用户名信息.',
	'edit_role_name_label'             => '用户组名:',
	'edit_role_desc_label'             => '用户组描述:',
	'edit_role_submit_btn'             => '用户组已保存',
	'edit_role_validation_name_label'  => '用户组名',
	'edit_role_validation_desc_label'  => '用户组描述',
