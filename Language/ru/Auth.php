 ...
 * Created:  03.09.2013
 *
 * Description:  Russian language file for Atomic Auth views
 *
 */
...
return [
	...
	'index_create_role_link' => 'Создать новую группу',
	...
	'edit_user_roles_heading'                    => 'Член группы',
	...
	'edit_user_validation_roles_label'           => 'Группы',
	'edit_user_validation_password_label'         => 'Пароль',
	'edit_user_validation_password_confirm_label' => 'Подтверждение пароля',

	// Create Group
	'create_role_title'                  => 'Создать группу',
	'create_role_heading'                => 'Создать группу',
	'create_role_subheading'             => 'Пожалуйста заполните следующую информацию.',
	'create_role_name_label'             => 'Группа:',
	'create_role_desc_label'             => 'Описание:',
	'create_role_submit_btn'             => 'Создать группу',
	'create_role_validation_name_label'  => 'Группа',
	'create_role_validation_desc_label'  => 'Описание',

	// Edit Group
	'edit_role_title'                  => 'Редактировать группу',
	'edit_role_saved'                  => 'Группа сохранена',
	'edit_role_heading'                => 'Редактировать группу',
	'edit_role_subheading'             => 'Пожалуйста заполните следующую информацию.',
	'edit_role_name_label'             => 'Название группы:',
	'edit_role_desc_label'             => 'Описание:',
	'edit_role_submit_btn'             => 'Сохранить группу',
	'edit_role_validation_name_label'  => 'Группа',
	'edit_role_validation_desc_label'  => 'Описание',
